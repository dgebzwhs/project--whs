    ...
    <el-header id="header">
      ...
      <ul class="personal">
        ...
        <li >
          ...
          <el-button type="text" v-if="islogin==false" @click="toLogin()">登录</el-button>
        </li>
        <li class="icon" v-if="islogin==true"><img :src="avatar"/></li>
      </ul>
    </el-header>
    <tabNav></tabNav>
  </div>
    ...
    methods: {
      ...
      getNR(){
        if(store.getters.token){
          ...
          this.role=this.$store.getters.info.role
          this.islogin=true
        }
        else{
          this.role="游客"
