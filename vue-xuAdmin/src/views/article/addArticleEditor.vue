  ...
  <div class="addArticle">
    <el-form ref="article" :inline="true" :model="article" label-width="80px">
      <el-form-item label="文章标题">
        <el-input class="title" placeholder="文章标题" v-model="article.title"></el-input>
      </el-form-item>
...
<!--      </el-form-item>-->
      <el-form-item>
        <el-button class="subBtn" type="primary" @click="addArticle">发布</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      addArticle(){
        ...
        console.log()
        if(this.article.yuan != '' && this.article.yi != '' && this.article.title != '') {
          this.$axios({
            method: 'post',
            url: 'api/article/add',
            params: {
              'yuan': this.article.yuan,
              'yi': this.article.yi,
